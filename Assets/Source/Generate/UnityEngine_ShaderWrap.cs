...
public class UnityEngine_ShaderWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("WarmupAllShadersAsync", WarmupAllShadersAsync);
		L.RegFunction("WarmupAllShadersWait", WarmupAllShadersWait);
		L.RegFunction("GetWarmupProgress", GetWarmupProgress);
	...
	static int WarmupAllShaders(IntPtr L)
	{
		try
		{
			...
			else if (count == 1)
			{
				...
				UnityEngine.Shader.WarmupAllShaders(arg0);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Shader.WarmupAllShaders");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int WarmupAllShadersAsync(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 0)
			{
				UnityEngine.AsyncOperation o = UnityEngine.Shader.WarmupAllShadersAsync();
			...
			{
				bool arg0 = LuaDLL.luaL_checkboolean(L, 1);
				UnityEngine.AsyncOperation o = UnityEngine.Shader.WarmupAllShadersAsync(arg0);
				ToLua.PushObject(L, o);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Shader.WarmupAllShadersAsync");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int WarmupAllShadersWait(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			UnityEngine.Shader.WarmupAllShadersWait();
			return 0;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetWarmupProgress(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			float o = UnityEngine.Shader.GetWarmupProgress();
