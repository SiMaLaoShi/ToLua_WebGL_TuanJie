...
public class UnityEngine_AssetBundleWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("PreDownloadAsAssetAsync", PreDownloadAsAssetAsync);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int PreDownloadAsAssetAsync(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 2)
			{
				...
				UnityEngine.PreDownloadAsAssetRequest o = obj.PreDownloadAsAssetAsync(arg0);
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 3)
			{
				...
				UnityEngine.Object arg0 = (UnityEngine.Object)ToLua.CheckObject<UnityEngine.Object>(L, 2);
				System.Type arg1 = ToLua.CheckMonoType(L, 3);
				UnityEngine.PreDownloadAsAssetRequest o = obj.PreDownloadAsAssetAsync(arg0, arg1);
				ToLua.PushObject(L, o);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.AssetBundle.PreDownloadAsAssetAsync");
			}
		}
		catch (Exception e)
		{
